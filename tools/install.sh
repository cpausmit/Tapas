...
echo ""                                                            >> setup.sh
echo "export TAPAS_TOOLS_DEPEML=paus@mit.edu,nergis@mit.edu,cmodica@mit.edu,phys-finance@mit.edu,phys-gradappts@mit.edu,ktanaka@mit.edu,denisew@mit.edu" \
                                                                   >> setup.sh
echo ""                                                            >> setup.sh
